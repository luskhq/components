const addPaddingAll = stylesheet => {
  if (
    ...
    console.error(
      "Coulnd't add `paddingAll` mixin: The following rules have to be defined on the stylesheet object to be able to add it: `padding`, `paddingTop`, `paddingRight`, `paddingBottom`, `paddingLeft`",
    );
    return stylesheet;
  }
...
const addPaddingX = stylesheet => {
  if (!(stylesheet.paddingLeft && stylesheet.paddingRight)) {
    console.error(
      "Coulnd't add `paddingX` mixin: The following rules have to be defined on the stylesheet object to be able to add it: `paddingRight`, `paddingLeft`",
    );
    return stylesheet;
  }
...
const addPaddingY = stylesheet => {
  if (!(stylesheet.paddingTop && stylesheet.paddingBottom)) {
    console.error(
      "Coulnd't add `paddingY` mixin: The following rules have to be defined on the stylesheet object to be able to add it: `paddingTop`, `paddingBottom`",
    );
    return stylesheet;
  }
...
const addMarginAll = stylesheet => {
  if (
    ...
    console.error(
      "Coulnd't add `marginAll` mixin: The following rules have to be defined on the stylesheet object to be able to add it: `margin`, `marginTop`, `marginRight`, `marginBottom`, `marginLeft`",
    );
    return stylesheet;
  }
...
const addMarginX = stylesheet => {
  if (!(stylesheet.marginLeft && stylesheet.marginRight)) {
    console.error(
      "Coulnd't add `marginX` mixin: The following rules have to be defined on the stylesheet object to be able to add it: `marginRight`, `marginLeft`",
    );
    return stylesheet;
  }
...
const addMarginY = stylesheet => {
  if (!(stylesheet.marginTop && stylesheet.marginBottom)) {
    console.error(
      "Coulnd't add `marginY` mixin: The following rules have to be defined on the stylesheet object to be able to add it: `marginTop`, `marginBottom`",
    );
    return stylesheet;
  }
...
const addBorderAll = stylesheet => {
  if (
    ...
    console.error(
      "Coulnd't add `paddingAll` mixin: The following rules have to be defined on the stylesheet object to be able to add it: `borderColor`, `borderStyle`, `borderWidth`",
    );
    return stylesheet;
  }
